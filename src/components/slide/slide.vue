...
<template>
    <div class="rd-swipe">
        ...
        <!-- <div class="rd-swipe-prev" @click="preItem()"></div>
        <div class="rd-swipe-next" @click="nextItem()"></div> -->
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        // nextItem () {
        //     if (this.swipe.activeIndex === this.swiper.count) {
        //         this.turnTo(0)
        //     }
        //     else {
        //         this.turnTo(this.swipe.activeIndex)
        //     }
        // },
        // preItem () {
        //     if (this.swipe.activeIndex === 0) {
        //         this.turnTo(this.swiper.count - 1)
        //     }
        //     else {
        //         this.turnTo(this.swipe.activeIndex)
        //     }
