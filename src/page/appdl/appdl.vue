<template>
	<div>
		<div class="dl_top">
			<div class="s_center">
				<div class="dl_top_con">
					<img src="../../assets/images/erweima/app.jpg" alt="" class="app_ma">
					<div class="dl_btn">
						<a href="https://itunes.apple.com/cn/app/yi-tian-li-cai/id1094562960?mt=8" target="_blank"><i class="icon_iphone"></i>iPhone版下载</a>
						<a href="https://www.yitianlicai.com/apk"><i class="icon_android" target="_blank"></i>安卓版下载</a>
					</div>
				</div>
			</div>
		</div>
		<div class="dl_center">
			<ul class="s_center dl_con clearfix">
				<li><i class="dl_func_icon dl_func_icon1"></i><p class="fz16">更快捷</p><span class="fz14">随时随地掌握投资动态</span></li>
				<li><i class="dl_func_icon dl_func_icon2"></i><p class="fz16">更人性</p><span class="fz14">你的理财小助手</span></li>
				<li><i class="dl_func_icon dl_func_icon3"></i><p class="fz16">更放心</p><span class="fz14">抓住每一次优惠，省得更多，赚得更多</span></li>
			</ul>
			<div class="dl_con_ad"><img src="../../assets/images/appDownload/dl_center.jpg" alt=""></div>
		</div>
		<div class="dl_bottom">
			<div class="s_center">
				<p class="dl_bottom_sao">扫一扫二维码下载</p>
				<div class="dl_bottom_con">
					<img src="../../assets/images/erweima/app.jpg" alt="" class="app_ma">
					<div class="dl_btn">
						<a href="https://itunes.apple.com/cn/app/yi-tian-li-cai/id1094562960?mt=8" target="_blank"><i class="icon_iphone"></i>iPhone版下载</a>
						<a href="https://www.yitianlicai.com/apk"><i class="icon_android" target="_blank"></i>安卓版下载</a>
...
.dl_con_ad{ padding: 55px 0 45px; width: 874px; margin: 0 auto}

.dl_bottom{ height: 549px; background: #aaaaaa url("../../assets/images/appDownload/dl_bottom.jpg") center top;}
.dl_bottom_sao{ padding-top: 90px; font-size: 30px; color: #fff; text-align: center;}
.dl_bottom_con{ width: 630px; margin: 50px auto 0;}
.dl_bottom_con .app_ma{ float: left; background-color: #fff; width: 240px; height: 240px; padding: 7px;}
