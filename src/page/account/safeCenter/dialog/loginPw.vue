...
<div class="p_zcgtcmain" style="display: none">
  <dl class="p_zclist h40 clr">
    ...
    <dl class="p_zclist h30 clr">
        <dt>&nbsp;</dt>
        <dd>
            <span class="p_zcerror" v-if="newPassword == '' && newPasswordSureFlag"><i class="icon"></i>请再次输入新密码</span>
            <span class="p_zcerror" v-if="newPassword !== newPasswordSure && newPasswordSureFlag"><i class="icon"></i>两次输入的新密码不一致</span>
        </dd>
    </dl>
